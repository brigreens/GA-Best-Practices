...
def run_calculations(polymer, scoring_prop, unit_list, run_name):
...
def fitness_function(population, scoring_prop, unit_list, run_name):
    """
    ...
    for x in range(len(population)):
        ...
        run_calculations(polymer, scoring_prop, unit_list, run_name)
